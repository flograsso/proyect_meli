                        ...
                        <ul id="sidebarnav">
                            ...
                            <li>
                                <a class="has-arrow  " href="#" aria-expanded="false">
                                    ...
                                    <span class="hide-menu">Dashboard
                                        <span class="label label-rouded label-primary pull-right">2</span></span></a>
                            ...
                            <li>
                                ...
                                <ul aria-expanded="false" class="collapse">
                                    ...
                                    <li>
                                        <a href="chart-chartist.html">Chartist
                                        </a>
                                    </li>
                                    <li>
                            ...
                            <li>
                                <a class="has-arrow  " href="#" aria-expanded="false">
                                    ...
                                    <span class="hide-menu">Layout</span></a>
                                <ul aria-expanded="false" class="collapse">
                                    <li>
                            ...
                            <li>
                                <a class="has-arrow  " href="#" aria-expanded="false">
                                    ...
                                    <span class="hide-menu">Pages
                                        <span class="label label-rouded label-success pull-right">8</span></span></a>
                                <ul aria-expanded="false" class="collapse">

                                    <li>
                                        <a href="#" class="has-arrow">Authentication
                                            <span class="label label-rounded label-success">6</span></a>
                                        <ul aria-expanded="false" class="collapse">
                                            <li>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive m-t-40">
                                        <table id="table-listaPreguntas" class="table table-bordered table-striped">
                                            <thead>
                                                <tr>
                                                    <th>Pregunta</th>
                                                    <th>Respuesta</th>
